...
consolidated_model_df_raw = pb_model_df |> 
...
consolidated_model_df = consolidated_model_df_raw |>
...
```{r}
# consolidated_model_df_raw
# consolidated_model_df
# 
# consolidated_model_df_raw |>
#   select( -all_of(names(consolidated_model_df)[-1] ) )

consolidated_model_df_raw |> 
  select(1, Sport = id, disposition,location, body_region, disposition_group, location_group )  |>
  write_csv("../../clean_data/extra_model_info.csv")
...
init_split <- initial_split(model_df_final_detect, prop = .80, strata = "primary_mechanism")
...
init_split_bin <- initial_split(model_df_final_count_bin, prop = .80, strata = "primary_mechanism_bin")
